...
map.getView().fit([-204970.350900, 1375481.949479, -161835.268889, 1398717.792616], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CARTOGRAPHIE MODHEM DDC</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (59 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cartographie réalisée dans le cadre de la formation ......!';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Infrastructuralepastorale_7,
    colName: 'Type',
    zoom: 10,
    collapsed: true,
    map: map

...
lyr_Zonepastorale_4.set('fieldLabels', {'id': 'no label', 'Villages': 'no label', 'Balises': 'no label', 'Périmètr': 'no label', 'Superficie': 'no label', });
